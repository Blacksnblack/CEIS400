...
def get_debug_values():
    ...
    for i in range(2, 20): # create a bunch of users for testing manage Employees GUI with randomly chosen equipment that's borrowed
        ...
        emps.append(Employee(name=f"Test User {i}", password_hash=pass_hash, emp_id=f"{i}", contactInfo="email@gmail.com", isAdmin=True, skillIds=emp_skills, borrowedEquipIds=b_equips))
